      ...
      link: function (scope) {
        ...
        scope.close = function (evt) {
          ...
          if (modal && modal.value.backdrop && modal.value.backdrop != 'static' && (evt.target === evt.currentTarget)) {
            ...
            // Unlock screen
            document.removeEventListener('touchmove', $modalStack.modalFreezeWindow, false );
  ...
  .factory('$modalStack', ['$window', '$transition', '$timeout', '$document', '$compile', '$rootScope', '$$stackedMap',
    function ($window, $transition, $timeout, $document, $compile, $rootScope, $$stackedMap) {
      ...
      function removeModalWindow(modalInstance) {
        ...
        removeAfterAnimate(modalWindow.modalDomEl, modalWindow.modalScope, 10, function() {
      ...
      $modalStack.modalFreezeWindow = function (event){
        event.preventDefault(); 
      };
      ...
      $modalStack.open = function (modalInstance, modal) {
        ...
        // Lock screen
        document.addEventListener('touchmove', $modalStack.modalFreezeWindow, false );
              ...
              switch ( scope.tt_placement ) {
                ...
                default:
                  ttPosition = {
                    ...
                    left: position.left - (ttWidth / 2) + (element[0].clientWidth / 2)
                  };
                  break;
              }
...
angular.module("template/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/modal/window.html",
    "<div id='modal-wrapper'><div tabindex=\"-1\" class=\"reveal-modal fade {{ windowClass }}\"\n" +
    "  ng-class=\"{in: animate}\" style=\"display: block; visibility: visible\">\n" +
    "  <div class='modal-inside' ng-transclude></div>\n" +
    "</div></div>\n" +
    "");
}]);
